...
#define K_S_LAUNCHER_BATTERY_SET_FULL               "Встановити поточний заряд як 100%"
#define K_S_LAUNCHER_BATTERY_SET_FULL_CONFIRM       "Батарея повністю заряджена?\nUSB має бути відключено.\n\nВстановити %s В як 100%%?"
#define K_S_LAUNCHER_BATTERY_SET_FULL_ERROR         "Перед калібруванням зарядіть батарею"
#define K_S_LAUNCHER_BATTERY_RESET_FULL             "Скинути калібрування заряду"
#define K_S_LAUNCHER_BATTERY_RESET_FULL_CONFIRM     "Скинути збережений рівень 100%?"
#define K_S_LAUNCHER_BATTERY_VOLTAGE_CORRECTION     "Корекція напруги"
...
#define K_S_LAUNCHER_BATTERY_CORRECTION_SAVE        "Зберегти"
#define K_S_LAUNCHER_BATTERY_CORRECTION_CANCEL      "Скасувати"
#define K_S_LAUNCHER_BATTERY_RESET_CORRECTION       "Скинути корекцію напруги"
#define K_S_LAUNCHER_BATTERY_RESET_CORRECTION_CONFIRM "Скинути збережену корекцію напруги?"
