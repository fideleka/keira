...
#define K_S_LAUNCHER_BATTERY_SET_FULL               "Set current battery as 100%"
#define K_S_LAUNCHER_BATTERY_SET_FULL_CONFIRM       "Is the battery fully charged?\nUSB must be disconnected.\n\nSet %s V as 100%%?"
#define K_S_LAUNCHER_BATTERY_SET_FULL_ERROR         "Charge the battery before calibration"
#define K_S_LAUNCHER_BATTERY_RESET_FULL             "Reset battery-level calibration"
#define K_S_LAUNCHER_BATTERY_RESET_FULL_CONFIRM     "Reset the saved 100% reference?"
#define K_S_LAUNCHER_BATTERY_VOLTAGE_CORRECTION     "Voltage correction"
...
#define K_S_LAUNCHER_BATTERY_CORRECTION_SAVE        "Save"
#define K_S_LAUNCHER_BATTERY_CORRECTION_CANCEL      "Cancel"
#define K_S_LAUNCHER_BATTERY_RESET_CORRECTION       "Reset voltage correction"
#define K_S_LAUNCHER_BATTERY_RESET_CORRECTION_CONFIRM "Reset the saved voltage correction?"
